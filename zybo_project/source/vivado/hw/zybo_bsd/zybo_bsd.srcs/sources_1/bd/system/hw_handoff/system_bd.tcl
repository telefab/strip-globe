...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list CONFIG.C_ALL_INPUTS {1} CONFIG.C_GPIO_WIDTH {4} CONFIG.C_INTERRUPT_PRESENT {1}  ] $axi_btns
  ...
  # Create instance: axi_sws, and set properties
  set axi_sws [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_gpio:2.0 axi_sws ]
  set_property -dict [ list CONFIG.C_ALL_INPUTS {1} CONFIG.C_GPIO_WIDTH {4} CONFIG.C_INTERRUPT_PRESENT {1}  ] $axi_sws
...
CONFIG.PCW_IMPORT_BOARD_PRESET {./lib/xml/ZYBO_zynq_def.xml} CONFIG.PCW_IRQ_F2P_INTR {1} \
...
CONFIG.PCW_SDIO_PERIPHERAL_VALID {1} CONFIG.PCW_S_AXI_HP0_FREQMHZ {150} \
...
CONFIG.PCW_USE_S_AXI_HP0 {1} CONFIG.PCW_USE_S_AXI_HP1 {0} \
  ...
  connect_bd_intf_net -intf_net axi_btns_GPIO [get_bd_intf_ports BTNS] [get_bd_intf_pins axi_btns/GPIO]
  connect_bd_intf_net -intf_net axi_mem_intercon_M00_AXI [get_bd_intf_pins axi_mem_intercon/M00_AXI] [get_bd_intf_pins processing_system7_0/S_AXI_HP0]
  connect_bd_intf_net -intf_net axi_sws_GPIO [get_bd_intf_ports SWs] [get_bd_intf_pins axi_sws/GPIO]
  ...
  connect_bd_intf_net -intf_net processing_system7_0_axi_periph_M02_AXI [get_bd_intf_pins axi_sws/S_AXI] [get_bd_intf_pins processing_system7_0_axi_periph/M02_AXI]
  ...
  connect_bd_net -net axi_sws_ip2intc_irpt [get_bd_pins axi_sws/ip2intc_irpt] [get_bd_pins xlconcat_0/In1]
  ...
  connect_bd_net -net rst_processing_system7_0_97M_peripheral_aresetn [get_bd_pins axi_btns/s_axi_aresetn] [get_bd_pins axi_mem_intercon/M00_ARESETN] [get_bd_pins axi_mem_intercon/S00_ARESETN] [get_bd_pins axi_mem_intercon/S01_ARESETN] [get_bd_pins axi_sws/s_axi_aresetn] [get_bd_pins globe_0/s00_axi_aresetn] [get_bd_pins processing_system7_0/FCLK_RESET1_N] [get_bd_pins processing_system7_0_axi_periph/M00_ARESETN] [get_bd_pins processing_system7_0_axi_periph/M01_ARESETN] [get_bd_pins processing_system7_0_axi_periph/M02_ARESETN] [get_bd_pins processing_system7_0_axi_periph/S00_ARESETN]
